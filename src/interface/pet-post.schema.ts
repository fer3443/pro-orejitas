...
export const petPostSchema = z.object({
  ...
  description: z.string().min(10, "La descripción debe tener al menos 10 caracteres").max(450,"Máximo de 450 caracteres"),
  ...
  image: z.array(z.string().url()).min(1, "Debe haber al menos 1 imagen").max(3,"No podes subir más de 3 imágenes."),
